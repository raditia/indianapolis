...
public class RecommendationControllerTest {
    ...
    public void getAllRecommendationFleetResult_OK() throws Exception {
        ...
        mockMvc.perform(get("/api/recommendation/result")
                ...
                .andExpect(jsonPath("$.data.recommendationResultResponseList[0].fleetResponseList[0].recommendationFleetId", equalTo(RecommendationResponseUtil.recommendationResponseCompleteAttribute.getRecommendationResultResponseList().get(0).getFleetResponseList().get(0).getRecommendationFleetId())))
