        ...
        for (DatabaseQueryResult result:resultList
            ...
            if(!skuIdList.contains(productId)){
                ...
                Product product = Product.builder()
                        ...
                        .width(result.getCffGoods().getWidth())
                        .length(result.getCffGoods().getLength())
                        .height(result.getCffGoods().getHeight())
                        .weight(result.getCffGoods().getWeight())
                        .quantity(result.getCffGoods().getQuantity())
                        .quantityForLaff(result.getCffGoods().getQuantity())
