...
public class Box extends Dimension {
	...
	public Box(double w, double d, double h, double weight) {
		super(w, d, h);

		this.weight = weight;
	}

	public Box(String name, double w, double d, double h, double weight) {
		super(name, w, d, h);

		this.weight = weight;
	}

	public Box(final Dimension dimension, final double weight) {
	...
	private boolean heightUp(double w, double d, double h) {
	...
	private boolean widthUp(double w, double d, double h) {
	...
	private boolean depthUp(double w, double d, double h) {
	...
	private boolean rotateLargestFootprint3D(double w, double d, double h) {
	...
	boolean fitRotate3DSmallestFootprint(double w, double d, double h) {
