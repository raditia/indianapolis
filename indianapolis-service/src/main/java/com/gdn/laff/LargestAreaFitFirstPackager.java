...
public class LargestAreaFitFirstPackager extends Packager {
	...
	private Box bestVolume(List<Box> containerProducts, Space space, double freeWeight) {
	...
	private Placement bestVolumePlacement(List<Box> containerProducts, Space[] spaces, double freeWeight) {
